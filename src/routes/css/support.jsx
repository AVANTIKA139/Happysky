...
function Support() {
  ...
  const copyWebLink = () => {
    navigator.clipboard
      .writeText("https://skyclubindia.netlify.app")
      .then(() => {
        ...
        >
          ...
          >
            <div style={{ textAlign: "center", marginTop: "2%" }}>
              ...
              <Typography variant="h4" className="fw-700" sx={{ mt: 2 }}>
                Support the Project
              </Typography>
              <Typography>
                Your contribution towards this project helps us a lot!
              </Typography>
              <Typography sx={{ mt: 5 }}>
                You can also help us by sharing this website, So that more
                people can use our product. Or by contributing to our open
                source repository.
              </Typography>
              <Button
                onClick={() => {
                  openInNewTab(
                    "https://github.com/ManavMehta-Official/SkyClub"
                  );
                }}
                className="indigo-btn-outline"
                fullWidth
                sx={{ mt: 5 }}
              >
